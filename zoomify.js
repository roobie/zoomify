  ...
  return (function(document, window, undefined) {
    ...
    function init(cfg) {
      ...
      if (div_ref && img_ref) {
        ...
        img_original_width = img_ref.naturalWidth;
        img_original_height = img_ref.naturalHeight;
    ...
    return function (cfg) {
      ...
      if (!cfg.container) {
        throw new TypeError('container must be a reference to a div');
      }
